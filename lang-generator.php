...
<body>
    ...
    <div class="header">
        ...
        <div style="display:flex;justify-content:center;gap:8px;margin-top:14px;flex-wrap:wrap;">
            ...
            <a href="cyrillic-cleaner.php" style="padding:8px 20px;border-radius:20px;text-decoration:none;font-size:14px;font-weight:600;color:rgba(255,255,255,0.8);background:rgba(255,255,255,0.15);border:2px solid transparent;">Cyrillic Cleaner</a>
        </div>
    </div>
